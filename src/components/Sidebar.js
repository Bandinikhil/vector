...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className=" fixed w-[20%] top-32 left-3 z-50 sm:hidden"
      ...
      <aside
        ...
        } absolute md:visible md:inline md:fixed sm:top-24 left-0 top-36 z-40  h-full transition-transform -translate-x-full sm:translate-x-0`}
        aria-label="Sidebar"
      >
      ...
      <div
        onClick={handleOutsideClick}
        className="flex w-full overflow-auto  flex-col"
      >
        <Searchtable />
        <Table />
      </div>
